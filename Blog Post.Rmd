...
train_full <- fread('./input/train.csv')
stores <- c(1,2,3,21)
MinDate <- '2017-07-15'
MaxDate <- '2017-08-15'
...
train <- train_full[train_full$date >= MinDate,]
train <- train[train$store_nbr %in% stores,]
```
...
Dates <- seq.Date(from = as.Date('2017-08-16'), by = 'day', to = as.Date('2017-08-30' ))
